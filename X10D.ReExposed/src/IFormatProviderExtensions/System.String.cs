...
public static class FormatProviderExtensions
{
    ...
    public static string Format(this IFormatProvider formatProvider,
    ...
    public static string Format([StringSyntax(StringSyntaxAttribute.CompositeFormat)] this string format, object value)
    {
    ...
    /// <inheritdoc cref="string.Format(string,object[])"/>
    public static string Format([StringSyntax(StringSyntaxAttribute.CompositeFormat)] this string format, params object[] values)
    {
